                    ...
                    <form role="form" method="POST" action="" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="judul" name="judul" placeholder="Masukan Judul" value="<?= $berita['judul']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="penulis">Penulis</label><small class="text-danger"><?= form_error('penulis'); ?></small>
                                <input type="text" class="form-control" id="penulis" name="penulis" placeholder="Masukan penulis" value="<?= $berita['penulis']; ?>">
                            </div>
                            <div class="form-group">
                                ...
                                <select class="custom-select form-control" id="kategori" name="kategori" style="width: 100%;">
                                    ...
                                    <?php foreach ($kategori as $ktg) : ?>
                                        <?php if ($ktg['kategori'] == $berita['kategori']) : ?>
                                            <option selected value="<?= $ktg['kategori']; ?>"><?= $ktg['kategori']; ?></option>
                                        <?php else : ?>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd;" name="berita" id="berita"><?= $berita['berita']; ?></textarea>
                            </div>
                            <img src="<?= base_url('assets/dist/img/') . $berita['foto']; ?>" alt="" style="max-width: 30%;">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="date" class="form-control pull-right" id="tanggal" name="tanggal" value="<?= $berita['tanggal']; ?>">
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
